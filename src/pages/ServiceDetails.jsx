    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-dark-900 dark:text-white mb-4">Service Not Found</h2>
            ...
            >
              ...
              <div className="flex gap-4 mb-6">
                <div className="flex items-center gap-2 text-dark-700 dark:text-dark-300">
                  ...
                  <span className="font-semibold">Delivery: {service.deliveryTime}</span>
                </div>
                <div className="flex items-center gap-2 text-dark-700 dark:text-dark-300">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {service.features.map((feature, index) => (
                <div
                  key={index}
                  className="bg-dark-50 rounded-lg p-6 hover:bg-primary-50 transition-colors"
                >
                  <FaCheck className="text-green-500 text-xl mb-3" />
                  <p className="text-dark-900 font-medium">{feature}</p>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {service.technologies.map((tech, index) => (
                <span
                  key={index}
                  className="bg-white border-2 border-primary-600 text-primary-700 px-6 py-3 rounded-full font-semibold hover:bg-primary-600 hover:text-white transition-colors"
                >
                  {tech}
                </span>
              ))}
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {service.benefits.map((benefit, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 bg-white border border-dark-200 rounded-lg p-6 hover:border-primary-600 transition-colors"
                >
                  <FaCheck className="text-green-500 text-xl mt-1 flex-shrink-0" />
                  <p className="text-dark-700">{benefit}</p>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <div className="bg-dark-50 rounded-xl p-6 text-center">
                <p className="text-dark-600 font-semibold mb-2">Basic</p>
                <p className="text-4xl font-bold text-dark-900 mb-2">
                  ₹{service.pricing.basic}
                </p>
                <p className="text-dark-600 text-sm">Essential features</p>
              </div>
              <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-xl p-6 text-center text-white shadow-xl">
                <p className="text-primary-100 font-semibold mb-2">Standard</p>
                <p className="text-4xl font-bold mb-2">
                  ₹{service.pricing.standard}
                </p>
                <p className="text-primary-100 text-sm">Most popular choice</p>
              </div>
              <div className="bg-dark-50 rounded-xl p-6 text-center">
                <p className="text-dark-600 font-semibold mb-2">Premium</p>
                <p className="text-4xl font-bold text-dark-900 mb-2">
                  ₹{service.pricing.premium}
                </p>
                <p className="text-dark-600 text-sm">Complete solution</p>
              </div>
            </div>
          </motion.div>
